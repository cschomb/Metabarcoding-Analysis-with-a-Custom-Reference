...
|---|---|---|---|---|---|---|---|
|...|...|$${\color{green}plausible}$$ / $${color{red}implausible}$$ depending on presence in GBIF query|plausible / implausible depending on presence in GBIF query|plausible / implausible depending on presence in GBIF query|Remaining other candidates, that occur in the queried area according to GBIF|...|...|
